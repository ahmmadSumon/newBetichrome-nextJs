  ...
  return (
    <>
     <div className='flex flex-col justify-center items-center'>
      <div className='container text-center mt-16 mx-auto'>
        <h1 className='text-5xl'>Women's Collection</h1>
      </div>
      <div className="container grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 mx-auto"> {/* Add mx-auto to center the container */}
      {products.map((item) => (
        ...
        <div className='bg-white rounded-lg shadow-lg p-6 m-4 max-w-sm'>
          ...
          <p className="text-gray-600 mb-4">
            ...
            <span className="text-blue-500 cursor-pointer" onClick={() => handleToggleDescription(item.
id)}>
